...
/**
 * Theme — Navy scholar (matches AddCourse / AddTeacherVideos / ProfilePage)
 * ------------------------------------------------
          ...
          >
            <Box>
              ...
              <Text fontSize="xs" color="gray.500" mb="5">
                Fill out the information below and add your course.
              </Text>
            ...
            <Box display="flex" alignItems="center" gap="18px" pt="4">
              ...
              >
                <Heading size="xs">Add course</Heading>
              </Button>
              <Text
                fontSize="0.75rem"
                cursor="pointer"
