      ...
      <Box mt={NAVBAR_HEIGHT} p={{ base: "4%", md: "2% 3%" }}>
        ...
        >
          ...
          >
            ...
            <Heading size="md" color="white" mt="1" fontWeight="700" position="relative" zIndex="1">
              Course Videos
            </Heading>
          </Box>
          ...
          <Box p={{ base: "4%", md: "2% 3%" }} overflowX="auto">
            <Table variant="unstyled" w="100%" size={tableSize}>
              <Thead>
                <Tr>
                  {["Title", "Uploaded", "Description", "Views", "Link", "Actions"].map((h) => (
                    <Th
                      key={h}
                      fontSize="11px"
                ...
                {store?.length > 0 &&
                  store.map((el, i) => (
                    ...
                    >
                      ...
                      <Td color="gray.600" py="4" maxW="300px">
                      ...
                      <Td color="gray.500" py="4" maxW="200px">
