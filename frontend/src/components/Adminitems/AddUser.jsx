          ...
          >
            <Box>
              ...
              <Text fontSize="xs" color="gray.500" mb="5">
                Fill out the information below and add the user.
              </Text>
              ...
              <Box display="grid" gridTemplateColumns={{ base: "1fr", sm: "1fr 1fr" }} gap="14px">
                ...
                <Field id="job" label="Job" value={detail.job} onChange={handleChange} />
                <Box gridColumn={{ base: "auto", sm: "1 / -1" }}>
                  <Field id="image" label="Image URL" value={detail.image} onChange={handleChange} />
                </Box>
              </Box>
            </Box>
            ...
            <Box display="flex" alignItems="center" gap="18px" pt="4">
              ...
              >
                <Heading size="xs">Add user</Heading>
              </Button>
              <Text
                fontSize="0.75rem"
                cursor="pointer"
